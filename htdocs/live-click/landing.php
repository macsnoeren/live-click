<?php
/**
 * Landingspagina — publiek, geen login vereist.
 *
 * Verkoopt LiveGig aan muzikanten en linkt door naar registratie, login en
 * de principes-pagina. Ingelogde bezoekers sturen we direct naar het dashboard.
 */
...
<header class="site-top">
    <a href="landing.php" class="brand-link">
...
<section class="hero">
    ...
    <div class="hero-cta">
        ...
        <a href="principes.php" class="btn btn-outline-light">
            <i class="bi bi-heart"></i> Waar wij voor staan
        </a>
    </div>
